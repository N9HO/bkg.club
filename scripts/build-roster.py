...
def qrz_fetch_callsign(session_key: str, callsign: str, *, debug: bool = False) -> dict:
    """Look up a callsign. Returns {'state': str|None, 'country': str|None, 'image': str|None}."""
    empty = {"state": None, "country": None, "image": None}
    ...
    return {"state": state, "country": country, "image": image}
